...
<body class="bg-light">
   ...
   <!--  <nav class="container-fluid menu1">
    ...
    <section class="mt-5">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-3">
                                    <div class="mx-auto p-2 text-center">
                                        <a href="empresa.php" class="btn"><i
                                ...
                                <div class="col-sm-3">
                                    <div class="mx-auto p-2 text-center dropdown">
                                        <a href="GestionMaquinas.php" class="btn"><i
        ...
        <div class="container-fluid mt-5 mb-3 pt-1 text-center mapaLobby">
            <div class="container-fluid">
                <div class="row pl-5">
                    <div class="col-sm-3 mx-auto">
                        <h6 class="text-center font-weight-bold">Empresa</h6>
                        <small>
                            <a href="empresa.php" class="font-weight-light">Empresa</a>
                            <br>
                            <a href="GestionUsuarios.php" class="font-weight-light">Usuarios</a>
                            <br>
                            <a href="GestionContactos.php" class="font-weight-light">Contactos</a>
                        </small>
                    </div>
                    ...
                    <div class="col-sm-3 mx-auto">
                        ...
                        <small>
                            <a href="GestionMaquinas.php" class="font-weight-light">Maquina</a>
                            <br>
                        </small>
                    </div>
                    <div class="col-sm-1 py-2 mx-auto">
                    ...
                    <div class="col-sm-3 mx-auto">
                        ...
                        <small>
                            <a href="reportes.php" class="font-weight-light">Registros</a>
                            <br>
                        </small>
                    </div>
                </div>

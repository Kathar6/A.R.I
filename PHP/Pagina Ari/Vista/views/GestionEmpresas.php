...
<body>
  ...
  <section>
    ...
    <table class="table tablagest table-bordered">
      ...
      <?php 
        ...
        //Se trae la lista de las empresas registradas
        include "../../Modelo/lists/listarEmp.php";
          ...
          <div class="modal-body">
            <form id="formulario" action="../../Controlador/ControladorEmp.php" method="POST">
              <div class="panelModal">
                ...
                <i id="company" class="fas fa-building"></i>
  ...
  <script src="../js/ControladorbotonesEmp.js"></script>
</body>

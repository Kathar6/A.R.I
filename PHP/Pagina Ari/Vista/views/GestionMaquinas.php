...
<body>
  ...
  <!-- #region tabla  -->
    ...
    <table class="table tablagest table-bordered">
      <thead class="table-dark">
        <tr>
          <th scope="col">#</th>
          <th scope="col">Peso orgánico</th>
          <th scope="col">Peso plástico</th>
          <th scope="col">Peso papel y cartón</th>
      ...
      <?php 
        ...
        //Se trae la lista de las máquinas registradas y activadas
        include "../../Modelo/lists/listarMaq.php";
        ...
        echo '<tr id="tr'.$cont.'">';
         echo'<th scope="row" id="contador">'.$cont.'</th>';
          echo '<td class="deshabilitar" id="idMaq'.$cont.'">'.$row['idmaquina'].'</td>';
          echo '<td id="PesoOrg'.$cont.'">'.$row['pesoOrg'].'</td>';
          echo '<td id="PesoPlast'.$cont.'">'.$row['pesoPlast'].'</td>';
          echo '<td id="PesoPapel'.$cont.'">'.$row['pesoPapel'].'</td>';
          echo '<td id="Ubicacion'.$cont.'" class="ubicaciones">'.$row['ubicacion'].'</td>';
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content blq_modalA">
          <div class="modal-header">
            <h2 class="text-center text-dark mt-3" id="tituloModal">Nueva máquina</h2>
            <button type="button" class="close mr-1" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form id="formulario" action="../../Controlador/ControladorMaq.php" method="POST">
              <div class="panelModal">
                <div class="form-row text-center">
                  <h3 class="text-center text-dark mt-5">Datos de la máquina</h3>
                </div>
                <i id="machin" class="fas fa-dumpster"></i>
                <div class="form-row ml-5 mt-5">
                  <div class="col-sm-2">
                    <label>Peso orgánico:</label>
                  </div>
                  <div class="col-sm-1 mr-3">
                    <input type="number" name="pesoOrg" id="pesoOrg" class="form-control campos" required>
                  </div>
                  <div class="col-sm-2">
                    <label>Peso plástico:</label>
                  </div>
                  <div class="col-sm-1 mr-3">
                    <input type="number" name="pesoPlast" id="pesoPlast" class="form-control campos" required>
                  </div>
                  <div class="col-sm-2">
                    <label>Peso papel y cartón:</label>
                  </div>
                  <div class="col-sm-1 mr-3">
                    <input type="number" name="pesoPapel" id="pesoPapel" class="form-control campos" required>
                  </div>
                </div>
                <div class="form-row ml-5 mt-5 mb-5">
                  ...
                  <div class="col-sm-3">
                    <input type="text" name="ubicacion" id="ubicacion" class="form-control campos" required>
                  </div>
                </div>
                  ...
                  <div class="col-sm-2">
                    <input type="hidden" name="idMaq" id="IdMaq" class="form-control campos">
                  </div>
  ...
  <script src="../js/ControladorbotonesMaq.js"></script>
</body>

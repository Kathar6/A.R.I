...
<body>
  ...
  <nav class="container-fluid barraNav">
    ...
    <ul class="menuDesp justify-content-center pt-1 pb-1">
      ...
      <li>
        ...
        <ul>
          <li><a href="#">Gestión basuras</a></li>
    ...
    <div class="col-sm-12">
      <ul class="nav pt-1 pb-1 float-right">
        <li class="nav-item">
          <span class="btn"><i class="fas fa-user iconoUser"></i></span>
        </li>
        <li class="nav-item">
          <a href="#" class="nav-link">Usuario</a>
        </li>
        <li class="nav-item">
          <button type="button" class="btn dropdown-toggle text-white" data-toggle="dropdown" data-display="static"
            aria-haspopup="true" aria-expanded="false">
            <i class="fas fa-bars"></i>
          </button>
          <div class="dropdown-menu ddmPerfil">
            <a href="#" style="all:unset;"><button class="dropdown-item" type="button">Cerrar sesión</button></a>
          </div>
        </li>
      </ul>
    </div>
  ...
  <!-- #region alertas -->
    ...
    <table class="table tablagest table-bordered">
      ...
      <?php 
        ...
        //Se trae la lista de las basuras registradas
        include "../../Modelo/lists/listarBas.php";
        ...
        echo '<tr id="tr'.$cont.'">';
         echo'<th scope="row" id="contador">'.$cont.'</th>';
          echo '<td class="deshabilitar" id="IdBasT'.$cont.'">'.$row['idbasura'].'</td>';
          echo '<td id="NomBasT'.$cont.'" class="nombres">'.$row['nombasura'].'</td>';
          echo '<td id="IdCatT'.$cont.'">'.$row['idcat'].'</td>';
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content blq_modalA">
          <div class="modal-header">
            <h2 class="text-center text-dark mt-3" id="tituloModal">Nueva basura</h2>
            <button type="button" class="close mr-1" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form id="formulario" action="../../Controlador/ControladorBas.php" method="POST">
              <div class="panelModal">
                <div class="form-row text-center">
                  <h3 class="text-center text-dark mt-5">Datos de la basura</h3>
                </div>
                ...
                <div class="form-row ml-5 mt-5 mb-5">
                  ...
                  <div class="col-sm-2">
                    <input type="text" name="nomBas" id="NomBas" class="form-control campos" required>
                  </div>
                </div>
                ...
                <div class="col-sm-2">
                  <input type="hidden" name="idBas" id="IdBas" class="form-control campos">
                </div>
  ...
  <script src="../js/ControladorbotonesBas.js"></script>
</body>

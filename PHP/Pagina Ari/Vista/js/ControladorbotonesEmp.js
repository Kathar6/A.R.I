...
function guardar(){
    ...
    //Se obtiene el bloque donde está el campo para ingresar el RUT
    ...
    //Se quita la clase deshabilitar del bloque si es que contiene esta
...
function actualizar(btn){
    ...
    //Se coloca el bloque del rut en invisible

...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=latin1 COMMENT='Tabla para registrar las basuras';
...
INSERT INTO `categoria` VALUES (1,'Orgánicos'),(2,'Papel y cartón'),(3,'Plástico'),(4,'Metales');
...
CREATE TABLE `datocont` (
  ...
  `idempresa` int(11) NOT NULL COMMENT 'ID de la empresa',
  ...
  CONSTRAINT `fk_datocont_empresa1` FOREIGN KEY (`idempresa`) REFERENCES `empresa` (`idempresa`),
...
CREATE TABLE `empresa` (
  `idempresa` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID de la empresa ',
...
) ENGINE=InnoDB AUTO_INCREMENT=1000533073 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla para registrar los datos de la empresa';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='Tabla para registrar los historiales';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `historial` VALUES (1,3,0,'Bottle','2019-02-28 08:15:03',1),(2,1,0,'Plastic Bottle','2019-02-28 08:16:00',1),(3,1,0,'Plastic Bottle','2019-02-28 08:17:16',1);
...
CREATE TABLE `maquina` (
  ...
  `idempresa` int(11) NOT NULL COMMENT 'Id de la empresa a la cual pertenece la máquina',
  ...
  CONSTRAINT `fk_maquina_empresa1` FOREIGN KEY (`idempresa`) REFERENCES `empresa` (`idempresa`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla para registrar los datos de cadamáquina';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `maquina` VALUES (1,1000533072,50.5,35.5,20.5,'Medellin-Puerta del norte','Inactivada'),(2,1000533072,50.5,40.5,22.5,'Medellin-EPM','Inactivada');
...
INSERT INTO `usuario` VALUES ('1000089139','Mateo Alonso','Pabón Garcia','mpabon','1234','Activo'),('100053307','Juan Carlos','Alvarez','juanalv','1234','Inactivo'),('1000533072','Juan Esteban','Cortés Gómez','jcortes','1234','Activo'),('1048264545','Daniel David','Pineda Beltran','ElCoste','f700a6934e78cd908cb5665cd84f89318bfa2d43','Activo'),('1048264548','Daniel David','Pineda Beltran ','ElCoste199','f700a6934e78cd908cb5665cd84f89318bfa2d43','Inactivo'),('1090980','Juan Carlos','Armando Rojas','juanrojas','1234','Activo'),('109098009','Juan Carlos','Armando Ospina','juanrojas','1234','Activo'),('1193115426','David','Agudelo Valencia','dagudelo','1234','Activo'),('1216729104','Juan David','Correa Garcia','jcorrea','1234','Activo'),('2578345837','Ricardo','Milos','Ricardo','0d8bb123eee6edc452eca0d4d8b3787ea4365201','Activo');
...
set @nomEmp = (select nombEmpresa from empresa where nombEmpresa = nombreEmpres); 

case 
-- Procedimiento para guardar
when boton='guardar' then 
if @nomEmp = nombreEmpres then
select concat('La empresa ', nombreEmpres, ' ya se encuentra registrada ') as mensaje;
else
...
if @cedula = cedulaU then
	...
	if @userVal = 1 then
		select concat('El usuario ',usuarioU, 'ya existe, ingrese un usuario diferente') as MensajeVal;
	else
...
-- Procedimiento para actualizar  
when boton='actualizar' then
update usuario set nombres=nombresU, apellidos=apellidosU, passusua=sha(passU), estado=@estado  where cedula=cedulaU;
select * from usuario where cedula = cedulaU;
...
-- Dump completed on 2019-03-14 18:47:52
